...
cur_path=os.getcwd()
# WindowWithShade
sin_fil_path=os.path.join(cur_path,'single','WindowWithShade','WindowWithShade.mat')
dou_fil_path=os.path.join(cur_path,'double','WindowWithShade','WindowWithShade.mat')
...
plt.savefig('./results/'+'WindowWithShade'+'_'+'CFD(1)')
plt.show()
plt.close()
...
plt.savefig('./results/'+'WindowWithShade'+'_'+'CFD(2)')
plt.show()
plt.close()
...
for i in range (6):
    ...
    ax.legend(loc='lower right')
    plt.savefig('./results/'+'WindowWithShade'+'_'+'Q('+str(i+1)+')')
    plt.show()
    plt.close()
    ...
    ax.legend(loc='upper right')
    plt.savefig('./results/'+'WindowWithShade'+'_'+'T('+str(i+1)+')')
    plt.show()
    plt.close()
