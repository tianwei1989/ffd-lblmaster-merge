...
cur_path=os.getcwd()
# WindowWithoutShade
sin_fil_path=os.path.join(cur_path,'single','WindowWithoutShade','WindowWithoutShade.mat')
dou_fil_path=os.path.join(cur_path,'double','WindowWithoutShade','WindowWithoutShade.mat')
...
(t,sin7)=r_sin.values('roo.air.conExtWin[1].Q_flow')
(t,sin8)=r_sin.values('roo.air.conExtWin[2].Q_flow')
...
(t,sin13)=r_sin.values('roo.air.conExtWin[1].T')
(t,sin14)=r_sin.values('roo.air.conExtWin[2].T')
...
(t,dou7)=r_dou.values('roo.air.conExtWin[1].Q_flow')
(t,dou8)=r_dou.values('roo.air.conExtWin[2].Q_flow')
...
(t,dou13)=r_dou.values('roo.air.conExtWin[1].T')
(t,dou14)=r_dou.values('roo.air.conExtWin[2].T')
#print (t,dou14)
...
plt.savefig('./results/'+'WindowWithoutShade'+'_'+'CFD(1)')
plt.show()
plt.close
...
plt.savefig('./results/'+'WindowWithoutShade'+'_'+'CFD(2)')
plt.show()
plt.close()
...
for i in range (6):
    ...
    ax.legend(loc='lower right')
    plt.savefig('./results/'+'WindowWithoutShade'+'_'+'Q('+str(i+1)+')')
    plt.show()
    plt.close()
    ...
    ax.legend(loc='upper right')
    plt.savefig('./results/'+'WindowWithoutShade'+'_'+'T('+str(i+1)+')')
    plt.show()
    plt.close()
