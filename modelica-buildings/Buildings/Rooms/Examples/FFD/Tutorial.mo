...
<p>
For the natural convection case description lease refer to 
<a href=\"modelica://Buildings.Rooms.Examples.FFD.NaturalConvection\">Buildings.Rooms.Examples.FFD.NaturalConvection documentation</a>.
</p>
...
<li>
<a href=\"modelica://Modelica.Blocks.Routing.Multiplex3\">Modelica.Blocks.Routing.Multiplex3</a>. This block is used to concentrate three number inputs into one vector output. Name it as <code>multiple_x3</code>.
</li>
<li>
...
<li>
<p>
Set <code>qRadGai_flow</code>,<code>qConGai_flow</code> and <code>qLatGai_flow</code> to 0. Set <code>fixedHeatFlow</code> to 0. Set <code>TeasWal</code> to 273.15.
Set <code>TwesWal</code> to 274.15.
</p>
</li>
<li>
<p>
Use Simplified CFD Interface (SCI) to generate geometry input file for FFD. The length in X Y and Z is 1 m respectively. Use 20X20X20 uniform grids.
Set the time step size as 10 seconds. After generating the files which are by default name as <code>input.cfd</code> and 
<code>zeroone.dat</code>, rename them as <code>NaturalConvection.cfd</code> and <code>NaturalConvection.dat</code> respectively.
</p>
</li>
<li>
<p>
Revise the parameter input file for FFD. Carefully check below items:     
</p>
<pre>
...
<p>
Please note that some of the physical properties maybe fake. These parameters result in a Rayleigh Number of 1E5. Also check other items, such as the solver information.
</p>
</ol>
<p>
After building the models and generating the input files, one needs to set simulation stop time to 7200 seconds and choose Radau solver. Then click translation and simulation to launch the simulation. 
</html>",  revisions="<html>
<ul>
<li>
...
First implementation.
  ...
  model MixedConvectionTutorial "Tutorial for Mixed Convection case"
    extends Modelica.Icons.Example;
    package MediumA =
        Buildings.Media.GasesConstantDensity.MoistAirUnsaturated (
          T_default=283.15) "Medium model";
...
<p>
For the mixed convection case description please refer to 
<a href=\"modelica://Buildings.Rooms.Examples.FFD.MixedConvection\">Buildings.Rooms.Examples.FFD.MixedConvection documentation</a>.
</p>
<h4>Implementation</h4>
<p>
This section describes step by step how we implemented the model.
...
<li>
<a href=\"modelica://Modelica.Blocks.Sources.Constant\">Modelica.Blocks.Sources.Constant</a>. Three models are needed to specify that internal radiation, internal convective heat gain and internal latent heat gain are zero.
Name these models as <code>qRadGai_flow</code>, <code>qConGai_flow</code> and <code>qLatGai_flow</code> respectively.
</li>
<li>
<a href=\"modelica://Modelica.Blocks.Routing.Multiplex3\">Modelica.Blocks.Routing.Multiplex3</a>. This block is used to concentrate three number into one vector. Name it as <code>multiple_x3</code>.
</li>
<li>
<a href=\"modelica://Buildings.HeatTransfer.Source.FixedTemperature\">Buildings.HeatTransfer.Source.FixedTemperature</a>. Two models are needed to specify the temperature on the floor and other walls. 
Name them as <code>TFlo</code> and <code>TOthWal</code> respectively.Please note that it is necessary to claim <code>TOthWal</code> as a vector of 5 elements.
</li>
<li>
<a href=\"modelica://Buildings.Fluid.Sources.MassFlowSource_T\">Buildings.Fluid.Sources.MassFlowSource_T</a>. This model provides inlet air for the <code>roo</code>. Name it as <code>bouIn</code>. 
</li>
<li>
<a href=\"modelica://Buildings.Fluid.Sources.FixedBoundary\">Buildings.Fluid.Sources.FixedBoundary</a>. This model is the outdoor environment to which outlet of <code>roo</code> is connected. Name it as <code>bouOut</code>. 
</li>
</ul>
</li>
<li>
...
<li>
<p>
Set <code>qRadGai_flow</code>,<code>qConGai_flow</code> and <code>qLatGai_flow</code> to 0. Set <code>TFlo</code> to 303.15.
...
<li>
<p>
Connect components as shown in below figure. Please note to do it in script mode when connecting <code>bouIn</code> and <code>bouOut</code> with <code>roo</code>.
</p>
<p align=\"center\">
...
<li>
<p>
Use Simplified CFD Interface (SCI) to generate geometry input file for FFD. Use 20X20X20 stretched grids.
Set the time step size as 0.1 seconds. After generating the files which are by default name as <code>input.cfd</code> and 
<code>zeroone.dat</code>, rename them as <code>MixedConvection.cfd</code> and <code>MixedConvection.dat</code> respectively.
</p>
</li>
<li>
<p>
...
<p>
After building the models and generating the input files, one needs to set simulation stop time to 180 seconds and choose Radau solver. Then click translation and simulation to launch the simulation. 
</p>
</html>",  revisions="<html>
<ul>
<li>
...
First implementation.
      ...
      __Dymola_Commands(file=
       "modelica://Buildings/Resources/Scripts/Dymola/Rooms/Examples/FFD/Tutorial/MixedConvectionTutorial.mos"
          "Simulate and plot"),
